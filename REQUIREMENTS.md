...
- The tool system MUST support at minimum:
  ...
  - **Notifications**: Alert the user at a scheduled time or on a trigger condition
...
- The system MUST be accessible from a mobile device on the local network
...
### NFR-1: Latency
- End-to-end response latency (voice in → voice out) SHOULD be under 3 seconds for short queries on target hardware
